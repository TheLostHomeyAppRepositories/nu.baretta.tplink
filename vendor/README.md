`tplink-smarthome-api-5.0.3.tgz` is the compiled package for the
[v5.0.3 fork release](https://github.com/shaarkys/tplink-smarthome-api/releases/tag/v5.0.3).
...
```powershell
npm install ./vendor/tplink-smarthome-api-5.0.3.tgz --ignore-scripts
```
